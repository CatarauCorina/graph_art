...
def train_eval_model(model,
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        # Iterate over data.
        for idx, inputs in enumerate(dataloader['train']):
            if 'images' in inputs:
...
if __name__ == '__main__':
    ...
    dataset_len = {'train': cfg.TRAIN.EPOCH_ITERS * 1, 'test': cfg.EVAL.SAMPLES}
    image_dataset = {
    ...
    tfboardwriter = SummaryWriter('graph/simple_cross_graph_match')
    ...
    torch.save(model.state_dict(), f'pca_gm_sgd_train_conv.pth')
