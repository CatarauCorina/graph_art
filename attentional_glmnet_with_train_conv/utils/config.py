...
__C.VOC2011 = edict()
__C.VOC2011.KPT_ANNO_DIR = '../data/voc_processed/pascal_voc/annotations/'  # keypoint annotation
__C.VOC2011.ROOT_DIR = '../data/voc_processed/pascal_voc/images/'  # original VOC2011 dataset
...
__C.WILLOW = edict()
__C.WILLOW.ROOT_DIR = '../data/willow_processed/willow'
